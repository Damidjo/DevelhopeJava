...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println(ourNumber);
        String ourNumberString = Integer.toString(ourNumber);
    ...
    private static void exercise4() {
        ...
        convertedNumber *= 2;
        System.out.println("Doubled the value: " + convertedNumber);
        String concatenatedStr = Integer.toString(convertedNumber) + Integer.toString(convertedNumber);
        System.out.println("Concatenated the string: " + concatenatedStr);
        double convertedDouble = Double.parseDouble(concatenatedStr);
        double dividedNumber = convertedDouble / 3.5;
        System.out.println("Divided the number by 3.5: " + dividedNumber);
        double flooredNumber = Math.floor(dividedNumber);
        System.out.println("Removed decimal places using Math.floor: " + flooredNumber);
        double result = flooredNumber;
